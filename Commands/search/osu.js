  ...
  async run(msg, { user }) {
    try {
      ...
      const embed = new MessageEmbed()
        ...
        .addField('❯ Accuracy', data.accuracy || 'N/A', true)
        .addField('❯ Rank', data.pp_rank || 'N/A', true)
        .addField('❯ Plays', data.playcount || 'N/A', true)
        .addField('❯ Country', data.country || 'N/A', true)
        .addField('❯ Score', data.ranked_score || 'N/A', true)
        .addField('❯ Total score', data.total_score || 'N/A', true)
        .addField('❯ SS', data.count_rank_ss || 'N/A', true)
        .addField('❯ S', data.count_rank_s || 'N/A', true)
        .addField('❯ A', data.count_rank_a || 'N/A', true);
